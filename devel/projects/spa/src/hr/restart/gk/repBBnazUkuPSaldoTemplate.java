/****license*****************************************************************
**   file: repBBnazUkuPSaldoTemplate.java
...
public class repBBnazUkuPSaldoTemplate extends repBBnameUkPromSaldoOrigTemplate {

  public repBBnazUkuPSaldoTemplate() {
    System.out.println("Aj em alajv!!!!!"); //XDEBUG delete when no more needed
    this.ReportTemplate.setDefault(ep.RECORD_SOURCE, "JDOrepBBnazUkuPSaldo");
