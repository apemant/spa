/****license*****************************************************************
**   file: repBBnazUkuPSaldoAnalitikTemplate.java
...
public class repBBnazUkuPSaldoAnalitikTemplate extends repBBnameUkPromSaldoOrigTemplate {

  public repBBnazUkuPSaldoAnalitikTemplate() {
    System.out.println("Aj em alajv!!!!!"); //XDEBUG delete when no more needed
    this.ReportTemplate.setDefault(ep.RECORD_SOURCE, "JDOrepBBnazUkuPSaldoAnalitik");
