/****license*****************************************************************
**   file: repKarticeGK_Saldirana.java
...
public class repKarticeGK_Saldirana implements raReportData { //sg.com.elixir.reportwriter.datasource.IDataProvider {
...
/*
  public repKarticeGK_Saldirana(int idx) {
    if(idx==0){
      rb = 0;
    }
    ds.goToRow(idx);
  ...
  public java.util.Enumeration getData() {
    return new java.util.Enumeration() {
      ...
      public Object nextElement() {
        ...
        return new repKarticeGK_Saldirana(indx++);
      }
...
*/
  public String getNASLOV(){
    if(fkgk.isPrivremeno()) return "\nKONTO KARTICA - SALDIRANA - PRIVREMENA";
    return "\nKONTO KARTICA - SALDIRANA";
  }
...
//  }
  public String getDATUM(){
    if (fkgk.getSljed().equals("K")/*jrbDatKnjiz.isSelected()*/) return rdu.dataFormatter(ds.getTimestamp("DATUMKNJ"));
    else return rdu.dataFormatter(ds.getTimestamp("DATDOK"));
  }
  public java.sql.Date getDATUMKNJDATE(){
    if (fkgk.getSljed().equals("K")) return java.sql.Date.valueOf(ds.getTimestamp("DATUMKNJ").toString().substring(0,10));
  ...
  public String getDATUMLABEL(){
    if (fkgk.getSljed().equals("K")/*jrbDatKnjiz.isSelected()*/) return "Datum Knjiženja";
    else return "Datum dokumenta";
  }
  public int getRBR(){
  ...
  public String getCKON() {
    return ds.getString("BROJKONTA");//fkgk.getCKON();
  }
