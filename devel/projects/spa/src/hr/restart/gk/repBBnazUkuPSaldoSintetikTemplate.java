/****license*****************************************************************
**   file: repBBnazUkuPSaldoSintetikTemplate.java
...
public class repBBnazUkuPSaldoSintetikTemplate extends repBBnameUkPromSaldoOrigTemplate {

  public repBBnazUkuPSaldoSintetikTemplate() {
    System.out.println("Aj em alajv!!!!!"); //XDEBUG delete when no more needed
    this.ReportTemplate.setDefault(ep.RECORD_SOURCE, "JDOrepBBnazUkuPSaldoSintetik");
