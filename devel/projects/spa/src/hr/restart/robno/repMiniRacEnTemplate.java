/****license*****************************************************************
**   file: repMiniRacEnTemplate.java
...
public class repMiniRacEnTemplate extends repOTPvriOrigTemplate {
  ...
  public raReportSection createSectionHeader0() {
    ...
    sh.LabelMjestoDatum.defaultAlterer().setCaption("Date");
  ...
  public raReportSection createSectionFooter0() {
    ...
    LabelU_K_U_P_N_O.defaultAlterer().setCaption("Total");
