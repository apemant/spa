...
public class repMxPON extends mxReport {
...
//*** dodano
  ...
  private String getPartner()
  {
    ...
    if(!kupacTemp.equals("0") )
    {
      ...
      {
        if(secondRow.equals(""))
          secondRow = "<$newline$>"+formatStr("",14)+"MB: "+dm.getPartneri().getString("MB")+"<$newline$>"+"<$newline$>";
        else
          secondRow += ", MB: "+dm.getPartneri().getString("MB")+"<$newline$>"+"<$newline$>";
        brRedPartner +=1;
      }
      else
      {
