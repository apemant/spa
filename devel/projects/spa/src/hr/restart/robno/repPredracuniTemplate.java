/****license*****************************************************************
**   file: repPredracuniTemplate.java
...
public class repPredracuniTemplate extends repIzlazOrigTemplate {
...
//  zakaii::     sh.TextTEL.defaultAlterer().setVisible(false);
  ...
  public repPredracuniTemplate() {
    this.ReportTemplate.setDefault(ep.RECORD_SOURCE, "JDOrepPredracuni");
  }
}
