...
public class repRacSloTemplate extends repIzlazOrigTemplate {
  ...
  public raReportSection createSectionHeader0() {
    ...
    sh.LabelBroj.defaultAlterer().setCaption("Številka");
    ...
    sh.LabelNarudzba.defaultAlterer().setCaption("Naroèilo");
    sh.LabelIzlazni_dokument.defaultAlterer().setCaption("Ishodni dokument");
    sh.LabelNacin_placanja.defaultAlterer().setCaption("Naèin plaèila");
...
//    sh.removeModels(new raReportElement[] {sh.LabelNacinotpreme, sh.TextNAZNAC});
  ...
  public raReportSection createSectionHeader1() {
    ...
    sh.LabelRbr.defaultAlterer().setCaption("Št.");
    sh.LabelSifra.defaultAlterer().setCaption("Šifra");
    sh.LabelNaziv.defaultAlterer().setCaption("Opis");
    sh.LabelKolicina.defaultAlterer().setCaption("Kolièina");
  ...
  public raReportSection createSectionFooter1() {
    ...
    sh.LabelUkupno_s_porezom.defaultAlterer().setCaption("Za plaèilo");
