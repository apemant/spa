...
public class frmPorezi extends raMatPodaci {
  ...
  JraTextField jtfSNAZPOR3 = new JraTextField();
  JraTextField jtfSNAZPOR2 = new JraTextField();
  JraTextField jtfSNAZPOR1 = new JraTextField();
  ...
  private void jbInit() throws Exception {
    ...
    jtfSNAZPOR3.setColumnName("SNAZPOR3");
    jtfSNAZPOR3.setDataSet(getRaQueryDataSet());
    jtfSNAZPOR2.setColumnName("SNAZPOR2");
    jtfSNAZPOR2.setDataSet(getRaQueryDataSet());
    jtfSNAZPOR1.setColumnName("SNAZPOR1");
    jtfSNAZPOR1.setDataSet(getRaQueryDataSet());
    jcbPnp1.setText(" ");
    ...
    jp.add(jtfNAZPOR3,  new XYConstraints(410, 153, 105, -1));
    jp.add(jtfSNAZPOR3,   new XYConstraints(525, 153, 105, -1));
    ...
    jp.add(jtfNAZPOR1,   new XYConstraints(410, 103, 105, -1));
    jp.add(jtfSNAZPOR1,   new XYConstraints(525, 103, 105, -1));
    ...
    jp.add(jtfNAZPOR2,  new XYConstraints(410, 128, 105, -1));
    jp.add(jtfSNAZPOR2,   new XYConstraints(525, 128, 105, -1));
