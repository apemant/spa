...
public class repStatParDetGroups implements raReportData { //sg.com.elixir.reportwriter.datasource.IDataProvider {
...
//  repUtil ru = repUtil.getrepUtil();
  ...
  public String getPoCemu() {
    return "\n" + "DETALJNO PO GRUPAMA ARTIKALA";
  }
  
  public String getPRIKAZ() {
    return "Detaljno po grupama artikala";
  }
