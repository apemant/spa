/****license*****************************************************************
**   file: repMiniRacHrTemplate.java
...
public class repMiniRacHrTemplate extends repOTPvriOrigTemplate {
  ...
  public raReportSection createSectionHeader0() {
    ...
    sh.TextMB.defaultAlterer().setControlSource("=(string-append \"Porezni broj: \" [MBM])");
    
    sh.LabelRACUNOTPREMNICA.defaultAlterer().setCaption("\nR A È U N");
    sh.LabelBroj.defaultAlterer().setCaption("Broj");
    sh.LabelMjestoDatum.defaultAlterer().setCaption("Datum raèuna");
    sh.LabelDospijeceDatum.defaultAlterer().setCaption("Datum dospijeæa");
  ...
  public raReportSection createSectionHeader1() {
    ...
    LabelCijena.defaultAlterer().setCaption("Cijena (€)");
    LabelVrijednost.defaultAlterer().setCaption("Iznos (€)");
  ...
  public raReportSection createSectionFooter0() {
    ...
    LabelU_K_U_P_N_O.defaultAlterer().setCaption("Ukupno");
