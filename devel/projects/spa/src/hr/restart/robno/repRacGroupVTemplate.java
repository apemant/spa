...
public class repRacGroupVTemplate extends repIzlazGroupOrigTemplate {
...
//      sh.TextFAX.defaultAlterer().setVisible(false);
    ...
    // engl
    sh.LabelR_A_C_U_N.defaultAlterer().setCaption("INVOICE");
    sh.LabelBroj.defaultAlterer().setCaption("No.");
    sh.LabelMjestoDatum.defaultAlterer().setCaption("Place/Date of issue");
...
//    sh.removeModels(new raReportElement[] {sh.LabelNacinotpreme, sh.TextNAZNAC});
  ...
  public raReportSection createSectionHeader1() {
    ...
    long jmjGain = sh.LabelCijena.defaultAlterer().getLeft() - sh.LabelJmj.defaultAlterer().getLeft();
        
    sh.removeModel(sh.LabelRbr);
    sh.removeModel(sh.LabelJmj);
    ...
    sh.LabelKolicina.defaultAlterer().setLeft(sh.LabelKolicina.defaultAlterer().getLeft() + kolGain + jmjGain);
    ...
    sh.LabelNaziv.defaultAlterer().setWidth(sh.LabelNaziv.defaultAlterer().getWidth() + rbrGain + kolGain + jmjGain);
    ...
    sh.LabelKolicina.defaultAlterer().setCaption("Qty");
    sh.LabelCijena.defaultAlterer().setCaption("Price");
    sh.LabelPop.defaultAlterer().setCaption("Dsc");
    sh.LabelPor.defaultAlterer().setCaption("VAT");
    pnp.defaultAlterer().setCaption("Tax");
    sh.LabelIznos.defaultAlterer().setCaption("Amount");
  ...
  public raReportSection createDetail() {
    ...
    long jmjGain = sh.TextFC.defaultAlterer().getLeft() - sh.TextJM.defaultAlterer().getLeft();
    
    sh.removeModel(sh.TextRBR);
    sh.removeModel(sh.TextJM);
    ...
    sh.TextKOL.defaultAlterer().setLeft(sh.TextKOL.defaultAlterer().getLeft() + kolGain + jmjGain);

    sh.TextNAZART.defaultAlterer().setLeft(sh.TextNAZART.defaultAlterer().getLeft() - rbrGain);
    sh.TextNAZART.defaultAlterer().setWidth(sh.TextNAZART.defaultAlterer().getWidth() + rbrGain + kolGain + jmjGain);
  ...
  public raReportSection createSectionFooter1() {
    ...
    sh.LabelUkupno.defaultAlterer().setCaption("Total");
    sh.LabelPopust.defaultAlterer().setCaption("Discount");
    sh.LabelUkupno_bez_poreza.defaultAlterer().setCaption("Tax base");
    sh.LabelUkupno_porez.defaultAlterer().setCaption("Tax amount");
    sh.LabelUkupno_s_porezom.defaultAlterer().setCaption("Total incl. taxes");
    
    sh.LabelREKAPITULACIJA_POREZA.defaultAlterer().setCaption("TAX RATES");
    sh.LabelGrupa.defaultAlterer().setCaption("Tax rate");
    sh.LabelOsnovica.defaultAlterer().setCaption("Tax base");
    sh.LabelPorez.defaultAlterer().setCaption("Tax amount");
    
    sh.removeModel(sh.LabelSlovima_);
    sh.removeModel(sh.TextSLOVIMA);
    
    return sh;
  }

  public repRacGroupVTemplate() {
