...
//    fillReportVrdok();
  ...
  private static void fillReportDefTable() {
    String[][] repvrdok = {
      ...
      {"hr.restart.robno.repRacuniGroup", "ROT", "D", ""},
      {"hr.restart.robno.repRacuniGroupV", "IVO", "F", ""},
      ...
      {"hr.restart.robno.repRacHr", "IVH", "D", ""},
      {"hr.restart.robno.repRacEn", "IVE", "F", ""},
      {"hr.restart.robno.repRacSlo", "IVS", "F", ""},
      ...
      {"hr.restart.robno.repRacPnPL", "RAC", "D", ""},
      ...
      {"hr.restart.robno.repRacGroupV", "IVO", "F", ""},
      ...
      {"hr.restart.robno.repMiniRacSlo", "IVS", "F", ""},
      ...
      {"hr.restart.robno.repPonudaUkupno", "PON", "D", ""},
      ...
      {"hr.restart.robno.repOTPLOTfin", "OTP", "D", ""},
      {"hr.restart.robno.repOTPSKL", "OTP", "D", ""},
      {"hr.restart.robno.repOTPLOT", "OTP", "D", ""},
      {"hr.restart.robno.repOTPLOT2", "OTP", "D", ""},
      {"hr.restart.robno.repOTPsif", "OTP", "D", ""},
      {"hr.restart.robno.repKomIzd", "KIZ", "D", ""},
      ...
      {"hr.restart.robno.repDOS9", "DOS", "D", ""},
      {"hr.restart.robno.repDOSGetro", "DOS", "D", ""},
      {"hr.restart.robno.repOdjava", "KOD", "", ""},
