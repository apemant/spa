...
public class RaRobnoMiniSaldakSH0 extends raReportSection {
  ...
  private String[] Rectangle1Props = new String[] {"", "540", "2220", "4160", "2200", "", "", "", 
     "White", ""};
  ...
  private String[] TextNAZPARLProps = new String[] {"NAZPARL", "", "", "", "", "", "Yes", "Yes", 
     "420", "2420", "4360", "840", "", "", "", "", "", "", "Lucida Bright", "", "Bold", "", "", "", 
     ""};
  ...
  private String[] Rectangle3Props = new String[] {"", "180", "2580", "4880", "1500", "", "", "", 
     "White", ""};
  ...
  private String[] TextPremaEvidencijiProps = new String[] {"PremaEvidenciji", "", "", "", "", "", 
     "Yes", "", "220", "6460", "10200", "600", "", "", "", "", "", "", "Lucida Bright", "", "", "", "", 
     "", ""};
  ...
  private String[] LabelMOLIMO_VAS_DA_NAMProps = new String[] {
     ...
     "", "220", "7480", "10200", "1300", "", "", "", "", "", "", "Lucida Bright", "", "", "", "", 
     ""};
  ...
  private String[] LabelAProps = new String[] {"\n(A)", "", "6240", "11160", "360", "560", "", "", 
     "", "", "", "", "Lucida Bright", "", "", "", "", ""};
  ...
  private String[] Line6Props = new String[] {"", "", "6240", "12920", "4360", "0", "", 
     "Light Gray", ""};
