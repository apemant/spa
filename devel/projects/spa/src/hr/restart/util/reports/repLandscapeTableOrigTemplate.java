/****license*****************************************************************
**   file: repLandscapeTableOrigTemplate.java
...
public abstract class repLandscapeTableOrigTemplate extends raReportTemplate {
  ...
  private String[] PageSetupProps = new String[] {"560", "560", "560", "560", "Landscape", "",
     "11880", "16820", "", "", "0.0", "0.0", ""};
  public raReportSection Sections;
  public raReportElement Section0;
  private String[] Section0Props = new String[] {"Logo", "", "Yes", "", "Each Value", "", ""};
  ...
  private String[] TextDatumIspProps = new String[] {"DatumIsp", "", "", "", "", "", "", "",
     "14540", "480", "1080", "220", "", "", "", "", "", "", "Lucida Bright", "8", "", "", "",
     "Right", ""};
  public raReportElement Text1;
  private String[] Text1Props = new String[] {"=(if (> [Logo] 0) \"Datum ispisa :\" \"\")", "", "",
     "", "", "", "", "", "12700", "480", "1820", "220", "", "", "", "", "", "", "Lucida Bright",
     "8", "Bold", "", "", "", ""};
  ...
  private String[] TextTitleProps = new String[] {"Title", "", "", "", "", "", "", "", "", "",
     "15620", "760", "", "", "", "", "", "", "Lucida Bright", "14", "Bold", "", "", "Center", ""};
  public raReportElement TextSubTitle;
  private String[] TextSubTitleProps = new String[] {"SubTitle", "", "", "", "", "", "", "", "",
     "440", "15620", "600", "", "", "", "", "", "", "Lucida Bright", "11", "Bold", "", "", "Center",
     ""};
  ...
  private String[] Text2Props = new String[] {
     ...
     "", "", "", "", "12900", "200", "2700", "220", "", "", "", "", "", "", "Lucida Bright", "8",
     "", "", "", "Right", ""};
  public raReportSection ReportFooter;

  public repLandscapeTableOrigTemplate() {
