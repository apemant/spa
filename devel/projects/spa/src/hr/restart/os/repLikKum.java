...
public class repLikKum implements sg.com.elixir.reportwriter.datasource.IDataProvider
{

  sysoutTEST sys = new sysoutTEST(false);
  _Main main;
  DataSet ds = ispLikvi.getQdsIspis();
  ...
  {
    StringBuffer sb = new StringBuffer(ispLikvi.datumOd);
    sb.replace(2,3,".");
    sb.replace(5,6,".");
    return sb.toString();
  }
  ...
  {
    StringBuffer sb = new StringBuffer(ispLikvi.datumDo);
    sb.replace(2,3,".");
    sb.replace(5,6,".");
    return sb.toString();
  }
  ...
  {
    return ispLikvi.sume[0];
  }

  public double getSumIsp()
  {
    return ispLikvi.sume[1];
  }

  public double getSumSaldo()
  {
    return ispLikvi.sume[2];
  }
