...
public class jpKarticaDetail extends JPanel {
  ...
  private void jbInit() throws Exception {
    ...
    jpDetail.add(jlId, new XYConstraints(15, 185, -1, -1));
    jpDetail.add(jlOpis, new XYConstraints(15, 160, -1, -1));
    jpDetail.add(jlSaldo, new XYConstraints(415, 185, -1, -1));
