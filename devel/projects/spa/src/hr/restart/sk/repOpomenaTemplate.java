...
public class repOpomenaTemplate extends repRobnoMiniSaldakCparOrigTemplate {


  public repOpomenaTemplate() {
    System.err.println("TEMPLATE KLASA _ repOpomenaTemplate");
  }
  ...
  public raReportSection createSectionHeader0() {
    ...
    try {
      sh0.LabelIZVADAK.defaultAlterer().setCaption("OPOMENA");
      sh0.LabelPosiljalac_izvatka.defaultAlterer().setCaption("Za vjerovnika");
      sh0.LabelMOLIMO_VAS_DA_NAM.defaultAlterer().setCaption("\nMOLIMO VAS DA NAM NAVEDENI IZNOS ODMAH UPLATITE. U PROTIVNOM BITI ÆEMO PRISILJENI TERETITI VAS ZA ZAKONSKU KAMATU, ODNOSNO PODUZETI I OSTALE MJERE PREDVIÐENE ZAKONSKIM PROPISIMA.");
      ...
      raReportSection toInvisible = sh0.defaultAltererSect().getView(sh0.Line4, sh0.LabelPotpis);
      toInvisible.setTransparent(true);
