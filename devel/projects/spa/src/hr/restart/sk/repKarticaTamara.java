...
public class repKarticaTamara implements raReportData {
  _Main main;
  raIspisKartica rik = raIspisKartica.getInstance(raIspisKartica.DOSP120); 
  DataSet ds;
  DataSet totals;
...
//******************** M O J I  P O D A C I ******************************
  ...
  {
    return "\nNEPLAÆENI RAÈUNI "+(rik.isKupac() ? "ZA KUPCE" : "DOBAVLJAÈA")+" na dan "+
      rdu.dataFormatter(rik.getLastDay());
  }
