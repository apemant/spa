...
public class repBlagIzvUplatnice implements raReportData { //sg.com.elixir.reportwriter.datasource.IDataProvider {
  ...
  public repBlagIzvUplatnice() {
    ru.setDataSet(ds);
  }

  /*public repBlagIzvUplatnice(int idx) {
    if(idx==0){
      rb = 0;
    }
    ds.goToRow(idx);
  ...
  public java.util.Enumeration getData() {
    return new java.util.Enumeration() {
      ...
      public Object nextElement() {
        ...
        return new repBlagIzvUplatnice(indx++);
      }
