...
//    jlPozOd.setText("poziv");
    ...
    jlPozivZad.setText("Poziv na broj zadu�enja");
//    jlRbr.setText("Rbr");
...
//    jlSif1.setText("�ifra");
    ...
    jlDatumPodnoshenja.setText("Datum podno�enja");
    ...
    jlOpisPlacanja.setText("Opis pla�anja");
    ...
    jlSifraNacPl.setText("�ifra op. pl.");
...
//    jlHica.setText("Hitnost");
    ...
    jlNalogZaPlacanje.setText("NALOG ZA PLA�ANJE");
