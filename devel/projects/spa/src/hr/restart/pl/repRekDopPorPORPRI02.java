/****license*****************************************************************
**   file: repRekDopPorPORPRI02.java
...
public class repRekDopPorPORPRI02 implements sg.com.elixir.reportwriter.datasource.IDataProvider {

  hr.restart.robno._Main main;
  frmRekDopPor frdp = frmRekDopPor.getFrmRekDopPor();
  DataSet ds = frdp.getRepQDSPorPri1();
//  DataSet priset = frdp.getRepQdsPri();
  ...
  public repRekDopPorPORPRI02() {
  }

  public repRekDopPorPORPRI02(int idx) {
    if (idx == 0){
...
//      ST.prn(ds);
  ...
  public java.util.Enumeration getData() {
    return new java.util.Enumeration() {
    {
      ...
      public Object nextElement() {
        ...
        return new repRekDopPorPORPRI02(indx++);
      }
  ...
  public String getOBRSTOPA(){
     return frdp.getObrstopa();
  }

  public String getOBROSN(){
     return frdp.getObrosn();
  }

  public String getOBRIZNOS(){
     return frdp.getObriznos();
  }
